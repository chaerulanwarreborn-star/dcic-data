...
def main() -> None:
    ...
    ap.add_argument("--side-events", default=str(RAW_DIR / "side_events_config.json"))
    ap.add_argument("--game-config", default=str(RAW_DIR / "game_config.json"))
    ap.add_argument("--localization", default=str(LOCALIZATION_DIR / "dragon_city_localization_baseline_en.json"))
    ap.add_argument("--dragons", default=str(DIST_DIR / "dragons.json"))
    ap.add_argument("--skins", default=str(DIST_DIR / "skins.json"))
    ap.add_argument("--chests", default=str(DIST_DIR / "chests.json"))
    ap.add_argument("--output", default=str(DIST_DIR / "wizards_hollow.json"))
