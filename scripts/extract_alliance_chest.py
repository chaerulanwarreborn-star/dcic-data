...
if __name__=='__main__':
    ...
    ap.add_argument('--reward-history',default=str(OVERRIDES_DIR/'alliance_chest_reward_history.json'))
    ...
    ap.add_argument('--output',default=str(DIST_DIR/'alliance_chest.json'))
