...
ARENA_PATH = RAW_DIR / "arena_config.json"
LOC_PATH = LOCALIZATION_DIR / "dragon_city_localization_baseline_en.json"
DRAGONS_PATH = DIST_DIR / "dragons.json"
SKINS_PATH = DIST_DIR / "skins.json"
SUMMARY_PATH = DIST_DIR / "chests.json"
DETAIL_DIR = REPO_ROOT / "chest-details"
