...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--game-config", default=str(RAW_DIR / "game_config.json"))
    p.add_argument("--localization", default=str(LOCALIZATION_DIR / "dragon_city_localization_baseline_en.json"))
    p.add_argument("--dragons", default=str(DIST_DIR / "dragons.json"))
    p.add_argument("--chests", default=str(DIST_DIR / "chests.json"))
    p.add_argument("--output", default=str(DIST_DIR / "event_collections.json"))
    return p.parse_args()
